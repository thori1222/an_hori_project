...
set(MSG_I_FLAGS "-Icustom_pkg:/home/thori/ccccc/src/custom_pkg/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/thori/ccccc/src/custom_pkg/msg/control_signal.msg" NAME_WE)
add_custom_target(_custom_pkg_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "custom_pkg" "/home/thori/ccccc/src/custom_pkg/msg/control_signal.msg" "std_msgs/Header"
)

get_filename_component(_filename "/home/thori/ccccc/src/custom_pkg/msg/six_states.msg" NAME_WE)
add_custom_target(_custom_pkg_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "custom_pkg" "/home/thori/ccccc/src/custom_pkg/msg/six_states.msg" ""
)
